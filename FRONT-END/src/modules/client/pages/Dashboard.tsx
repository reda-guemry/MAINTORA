      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-xs font-bold text-slate-700">
                High Risk: <span className="text-[#b91c1c] font-black">04</span>
              </p>
        ...
        <div className="col-span-12 md:col-span-6 lg:col-span-5 rounded-2xl bg-slate-900 p-6 shadow-sm border border-slate-800 text-white flex flex-col">
          <div className="flex items-start justify-between">
            ...
            <span className="material-symbols-outlined text-[#398e8e] text-4xl">
              energy_savings_leaf
            </span>
          </div>
      ...
      <div className="mt-8 rounded-2xl bg-white p-8 shadow-sm border border-slate-200">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Breakdown of performance indicators per primary machine.
            </p>
          </div>
          <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest">
            <div className="flex items-center gap-1.5">
              <div className="h-3 w-3 rounded-full bg-[#398e8e]"></div>
        ...
        <div className="space-y-6">
          ...
          {[
            ...
            <div
              key={i}
              className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 border-b border-slate-50 pb-6 last:border-0 last:pb-0"
            >
              ...
              <div className="flex w-32 md:justify-end">
                <span
                  className={`rounded px-2.5 py-1 text-[10px] font-bold uppercase ${asset.bg} ${asset.text}`}
                >
                  {asset.status}
                </span>
              </div>
              ...
              <tbody className="text-xs">
                <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-4 px-2">
                    <span className="px-2 py-1 rounded bg-slate-100 text-slate-600 font-bold uppercase text-[9px]">
                      Normal
                    </span>
                  </td>
                </tr>
                <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-4 px-2">
                    <span className="px-2 py-1 rounded bg-red-100 text-red-600 font-bold uppercase text-[9px]">
                      Critical
                    </span>
                  </td>
                </tr>
